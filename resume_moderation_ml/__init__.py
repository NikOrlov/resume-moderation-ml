...
class Application(MLBackApplication):
    def init_models(self) -> None:
        ...
        flag_models = ['careless_key_skill_information', 'careless_additional_information',
        ...
        self.dropsalary = {'classifier': load_model('dropsalary/classifier'),
                           'vectorizer': load_model('dropsalary/vectorizer')}
        self.vectorizer = load_model('vectorizer')

        predictor = ResumeModerationPredictor(vectorizer=self.vectorizer,
                                              models=self.models,
