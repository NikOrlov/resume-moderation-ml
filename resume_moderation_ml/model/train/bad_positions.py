...
def extract_moderator_name(resume):
    ...
    if moder_full_name is None:
        return None
    return (moder_full_name["lastName"] + " " + moder_full_name["firstName"]).lower()
...
def get_raw_data():
    ...
    return {"titles": titles, "targets": targets}
...
def get_model():
    ...
    log_reg = LogisticRegression(
        random_state=resume_moderation_config.bad_positions["seed"], **resume_moderation_config.bad_positions["log_reg"]
    )
