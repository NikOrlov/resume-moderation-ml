...
class ResumeModerationConfig(Config):
    ...
    def __init__(self):
        ...
        self.hh_db_config = {"database": "hh", "host": "dev-db2.pyn.ru", "port": 5432, "user": "hh", "password": "123"}
