...
COMMON_CONFIG = {
    "analyzer_opts": {"use_stemming": True},
    "vectorizer_opts": {
    ...
    "tf_idf_opts": {"norm": "l2", "use_idf": False, "sublinear_tf": True},
}

TEXT_FIELDS = {
    "title": {
        "extractor_opts": {"query": "title"},
        "analyzer_opts": {"use_stemming": False},
        "vectorizer_opts": {
            "max_df": 0.9995,
            "min_df": 0.0005,
            "max_features": 1000,
        },
        "tf_idf_opts": {"sublinear_tf": False},
    },
    "experience": {
        "extractor_opts": {"query": {"experience": ["companyName", "description", "position"]}},
        "vectorizer_opts": {"stop_words": stop_words, "max_df": 0.995, "min_df": 0.005, "max_features": 2000},
    },
    "education": {
        "extractor_opts": {
            "query": {
        ...
        "vectorizer_opts": {"max_df": 0.9975, "min_df": 0.0025, "max_features": 1000},
    },
    "university": {
        "extractor_opts": {"query": {"primaryEducation": "name"}},
        "vectorizer_opts": {"max_df": 0.9995, "min_df": 0.0005, "max_features": 1000},
    },
    "skill": {
        "extractor_opts": {"query": ["skills", "keySkills"]},
        "vectorizer_opts": {"max_df": 0.999, "min_df": 0.001, "max_features": 3000},
    },
    "recommendation": {
        "extractor_opts": {"query": {"recommendation": ["organization", "position"]}},
        "vectorizer_opts": {
            "max_df": 0.999,
            "min_df": 0.001,
            "max_features": 300,
    ...
    "name": {
        "extractor_opts": {"query": ["firstName", "middleName", "lastName"]},
        "analyzer_opts": {"use_stemming": False},
        "vectorizer_opts": {
            "max_df": 0.999,
            "min_df": 0.001,
